...
class InventarioMovimientoModel
{
    ...
    private function baseSelect(): string
    {
        return "
            SELECT
                ...
                c.nombre  AS cliente,   -- 👈 AQUÍ EL CAMBIO
            ...
            LEFT  JOIN ventas     v ON v.folio        = m.referencia
    ...
    public function listar(
        ...
        try {
            ...
            // Aquí vas a ver el error REAL de MySQL (tabla/columna/sintaxis)
            die('Error SQL (listar movs): '.$e->getMessage()."<br><pre>$sql</pre>");
        }
    ...
    // ===== LISTAR PARA EXPORTAR (sin paginar) =====
    public function listarParaExportar(
        ...
        try {
            ...
            die('Error SQL (exportar movs): '.$e->getMessage()."<br><pre>$sql</pre>");
        }
    ...
    public function contar(
        ...
        try {
            ...
            die('Error SQL (contar movs): '.$e->getMessage()."<br><pre>$sql</pre>");
        }
    ...
    public function obtenerPorId(int $idMovimiento){
        ...
        try {
            ...
            die('Error SQL (detalle mov): '.$e->getMessage()."<br><pre>$sql</pre>");
        }
