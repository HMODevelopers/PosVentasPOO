<style>
  #facturacionMultipleScreen .modal-dialog {
  ...
  #facturacionMultipleScreen .modal-content {
    border: 0;
    display: flex;
  ...
  #facturacionMultipleScreen #formFacturarVenta {
    display: flex;
    flex: 1 1 auto;
    flex-direction: column;
    min-height: 0;
  }
  #facturacionMultipleScreen .modal-header,
  #facturacionMultipleScreen .modal-footer {
    background: #fff;
    flex: 0 0 auto;
    position: relative;
    z-index: 2;
  }
  #facturacionMultipleScreen .modal-body {
    background: #f8fafc;
  ...
  #facturacionMultipleScreen .cfdi-section__body {
    padding: 1rem;
  }
  #facturacionMultipleScreen .cfdi-kv {
  ...
  #facturacionMultipleScreen .cfdi-kv span {
    color: #1f2d3d;
    display: block;
    word-break: break-word;
  }
  #facturacionMultipleScreen .cfdi-total-box {
    background: #f4f7fb;
    border: 1px solid #dfe7f1;
    border-radius: 0.75rem;
    padding: 1rem;
  }
  #facturacionMultipleScreen .cfdi-total-row {
    align-items: center;
    display: flex;
    justify-content: space-between;
    margin-bottom: 0.55rem;
  }
  #facturacionMultipleScreen .cfdi-total-row:last-child {
    margin-bottom: 0;
  }
  #facturacionMultipleScreen .cfdi-total-row--grand {
    border-top: 1px dashed #cfd8e3;
    margin-top: 0.8rem;
    padding-top: 0.8rem;
  }
  #facturacionMultipleScreen .cfdi-total-row--grand strong:last-child {
    font-size: 1.1rem;
  }
  #facturacionMultipleScreen .table td,
  #facturacionMultipleScreen .table th {
    vertical-align: middle;
  }
  #facturacionMultipleScreen .select2-container {
    width: 100% !important;
  }
  #facturacionMultipleScreen .select2-container--open {
    z-index: 2055;
  }
  #facturacionMultipleScreen .select2-dropdown {
    z-index: 2056;
  }
  #facturacionMultipleScreen .select2-container--default .select2-selection--single {
    border: 1px solid #ced4da;
    border-radius: 0.25rem;
    height: calc(1.5em + 0.75rem + 2px);
    padding: 0.275rem 0.25rem;
  }
  #facturacionMultipleScreen .select2-container--default .select2-selection--single .select2-selection__rendered {
    line-height: 1.8;
    padding-left: 0.5rem;
    padding-right: 1.75rem;
  }
  #facturacionMultipleScreen .select2-container--default .select2-selection--single .select2-selection__arrow {
    height: calc(1.5em + 0.75rem + 2px);
  }
  #facturacionMultipleScreen .select2-results__option {
    transition: background-color 0.15s ease, color 0.15s ease;
  }
  #facturacionMultipleScreen .cfdi-select2-option {
    color: #1f2d3d;
    display: flex;
    flex-direction: column;
    gap: 0.2rem;
  ...
  #facturacionMultipleScreen .cfdi-select2-option__title,
  #facturacionMultipleScreen .cfdi-select2-option__meta,
  #facturacionMultipleScreen .cfdi-select2-option__secondary {
    color: inherit;
  }
  #facturacionMultipleScreen .cfdi-select2-option__title {
    font-weight: 700;
  ...
  #facturacionMultipleScreen .select2-container--default .select2-results__option--highlighted[aria-selected],
  #facturacionMultipleScreen .select2-container--default .select2-results__option[aria-selected='true'] {
    color: #fff;
  }
  #facturacionMultipleScreen .select2-container--default .select2-results__option--highlighted[aria-selected] .cfdi-select2-option,
  #facturacionMultipleScreen .select2-container--default .select2-results__option--highlighted[aria-selected] .cfdi-select2-option *,
  #facturacionMultipleScreen .select2-container--default .select2-results__option[aria-selected='true'] .cfdi-select2-option,
  #facturacionMultipleScreen .select2-container--default .select2-results__option[aria-selected='true'] .cfdi-select2-option * {
    color: #fff !important;
  }
  #facturacionMultipleScreen .cfdi-helper {
    color: #7a8797;
    font-size: 0.78rem;
  }
  #facturacionMultipleScreen .cfdi-select-block .select2-selection--single {
    background-color: #fff;
  }

  #facturacionMultipleScreen .cfdi-block-status {
    display: grid;
    gap: 0.75rem;
    grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));
    margin-bottom: 1rem;
  }
  #facturacionMultipleScreen .cfdi-block-status__item {
    background: #f8fafc;
    border: 1px solid #dfe7f1;
    border-radius: 0.75rem;
    padding: 0.85rem 0.95rem;
  }
  #facturacionMultipleScreen .cfdi-block-status__item.is-complete {
    border-color: #b7ebc6;
    background: #f0fff4;
  }
  #facturacionMultipleScreen .cfdi-block-status__item.is-incomplete {
    border-color: #f5c2c7;
    background: #fff5f5;
  }
  #facturacionMultipleScreen .cfdi-block-status__title {
    align-items: center;
    display: flex;
    font-size: 0.84rem;
    font-weight: 700;
  ...
  #facturacionMultipleScreen .cfdi-block-status__desc {
    color: #526273;
    font-size: 0.8rem;
    margin: 0;
  }
  #facturacionMultipleScreen .cfdi-validation-list {
    display: grid;
    gap: 0.6rem;
    list-style: none;
    margin: 0;
  ...
  #facturacionMultipleScreen .cfdi-validation-list__item {
    background: #fff8e6;
  ...
  #facturacionMultipleScreen .cfdi-validation-list__item strong {
    color: #5a4300;
    display: block;
    font-size: 0.78rem;
    letter-spacing: 0.04em;
  ...
  #facturacionMultipleScreen .cfdi-validation-list__item.is-success {
    background: #f0fff4;
    border-color: #b7ebc6;
    color: #1f6f43;
  }
...
<!-- Facturación múltiple (clon de flujo actual) -->
<div id="facturacionMultipleScreen" class="card mb-0">
  <div class="card-body p-0">
      <form id="formFacturarVenta" autocomplete="off">
        <div class="modal-header">
          <h5 class="modal-title" id="modalFacturarVentaLabel">Facturar varios tickets</h5>
        </div>
              ...
              <div class="cfdi-section__body">
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12">
                    ...
                    <div class="cfdi-kv"><small>Tickets agregados</small><span id="fac-multi-tickets">0</span></div>
                  </div>
                </div>
              </div>
            </div>
