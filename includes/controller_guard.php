...
function controller_permission_map(): array {
    return [
        ...
        'CatSatUsoCfdiController.php'      => 'catalogos.menu',
        'CatSatRegimenFiscalController.php'=> 'catalogos.menu',
        'CatSatMonedaController.php'       => 'catalogos.menu',
        'ClientesSatController.php'        => 'catalogos.menu',
